...
flags.DEFINE_string('TRAIN_LIST', './data/raw/samples/list', 'List of training data...')
flags.DEFINE_string('TRAIN_LOCATION', './data/raw/samples/Images/', 'Location of training data. Could be included in the data list.')
flags.DEFINE_string('TRAIN_TRANS', './data/raw/samples/Labels/', 'Location of training data transcriptions')

######################################
#Validation data configuration
flags.DEFINE_integer('VAL_NB', 20, 'Number of validation images to process')
flags.DEFINE_string('VAL_LIST', './data/raw/samples/list',	'List of validation data without file extension.')
flags.DEFINE_string('VAL_LOCATION', './data/raw/samples/Images/', 'Location of validation data. Could be included in the data list.')
flags.DEFINE_string('VAL_TRANS', './data/raw/samples/Labels/', 'Location of validation data transcriptions')

######################################
#Test data configuration
flags.DEFINE_integer('TEST_NB', 20, 'Number of test images to process')
flags.DEFINE_string('TEST_LIST', './data/raw/samples/list', 'List of test data without file extension.')
flags.DEFINE_string('TEST_LOCATION', './data/raw/samples/Images/', 'Location of test data. Could be included in the data list.')
flags.DEFINE_boolean('WriteDecodedToFile', True, 'Write the decoded text to file or stdout?')

######################################
#Classes information
flags.DEFINE_string('CHAR_LIST', './data/raw/samples/CHAR_LIST', 'List of characters...')
...
flags.DEFINE_integer('NEpochs', 3, 'Run the training for n epochs')
